...
class LongScaleFeatureExtraction(nn.Module):
    def __init__(self,
                 dim,
                 num_heads,
                 ffn_expansion_factor=1.,  
                 qkv_bias=False,):
        super(LongScaleFeatureExtraction, self).__init__()
...
class ShortScaleFeatureExtraction(nn.Module):
    def __init__(self, num_layers=3):
        super(ShortScaleFeatureExtraction, self).__init__()
...
class Restormer_Encoder(nn.Module):
    def __init__(self,
        ...
        self.baseFeature =LongScaleFeatureExtraction(dim=dim, num_heads = heads[2])
        self.detailFeature = ShortScaleFeatureExtraction()
